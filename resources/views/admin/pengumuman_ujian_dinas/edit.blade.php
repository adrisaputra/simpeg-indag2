...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/'.Request::segment(1).'/edit/'.$pengumuman_ujian_dinas->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('lokasi')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Lokasi" name="lokasi" value="{{ $pengumuman_ujian_dinas->lokasi }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('syarat')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" placeholder="Syarat" name="syarat">{{ $pengumuman_ujian_dinas->syarat }}</textarea>
						</div>
					</div>
					...
					<div class="form-group  @if ($errors->has('tanggal_mulai') || $errors->has('tanggal_selesai')) has-error @endif">
						...
						<div class="col-sm-3" @if($errors->has('tanggal_mulai') && $errors->has('tanggal_selesai')) @elseif ($errors->has('tanggal_selesai')) style="padding-top:27px" @endif>
							...
							<div class="input-group date">
                                    <div class="input-group-addon" @if($pengumuman_ujian_dinas->tanggal_mulai) style="border-color: #d3d7df;" @endif>
                                        <i class="fa fa-calendar" @if($pengumuman_ujian_dinas->tanggal_mulai) style="color: #555555;" @endif></i>
                                    </div>
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Mulai" name="tanggal_mulai" value="{{ $pengumuman_ujian_dinas->tanggal_mulai }}" @if($pengumuman_ujian_dinas->tanggal_mulai) style="border-color: #d3d7df;" @endif>
                                    </div>
						</div>
						<div class="col-sm-3" @if($errors->has('tanggal_mulai') && $errors->has('tanggal_selesai')) @elseif ($errors->has('tanggal_mulai')) style="padding-top:27px" @endif>
							...
							<div class="input-group date">
                                    <div class="input-group-addon" @if($pengumuman_ujian_dinas->tanggal_selesai) style="border-color: #d3d7df;" @endif>
                                        <i class="fa fa-calendar" @if($pengumuman_ujian_dinas->tanggal_selesai) style="color: #555555;" @endif></i>
                                    </div>
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Selesai" name="tanggal_selesai" value="{{ $pengumuman_ujian_dinas->tanggal_selesai }}" @if($pengumuman_ujian_dinas->tanggal_selesai) style="border-color: #d3d7df;" @endif>
                                    </div>
						</div>
					</div>
