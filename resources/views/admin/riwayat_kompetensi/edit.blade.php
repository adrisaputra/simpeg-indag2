...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Edit Data Kompetensi</h3>
		</div>
		
		<form action="{{ url('/riwayat_kompetensi/edit/'.$pegawai[0]->id.'/'.$riwayat_kompetensi->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('nama_kegiatan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Kegiatan" name="nama_kegiatan" value="{{ $riwayat_kompetensi->nama_kegiatan }}" >
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal" name="tanggal" value="{{ $riwayat_kompetensi->tanggal }}">
                                    </div>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('tempat')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Tempat" name="tempat" value="{{ $riwayat_kompetensi->tempat }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('angkatan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Angkatan" name="angkatan" value="{{ $riwayat_kompetensi->angkatan }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('arsip_kompetensi')) has-error @endif">
						...
						<div class="col-sm-4">
							...
							<input type="file" class="form-control" placeholder="Arsip Jabatan" name="arsip_kompetensi" value="{{ $riwayat_kompetensi->arsip_kompetensi }}" >
						...
						<div class="col-sm-2" @if($errors->has('arsip_kompetensi')) style="padding-top:27px" @else style="padding-top:2px" @endif >
							@if($riwayat_kompetensi->arsip_kompetensi)
								<a href="{{ asset('upload/arsip_kompetensi/'.$riwayat_kompetensi->arsip_kompetensi) }}" target="_blank" class="btn btn-sm btn-primary" >Lihat File</a>
							@endif
						</div>
					</div>
