...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/riwayat_cuti/edit/'.$pegawai[0]->id.'/'.$riwayat_cuti->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('jenis_cuti')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="jenis_cuti">
                                        ...
                                        <option value="Cuti Tahunan" @if($riwayat_cuti->jenis_cuti=="Cuti Tahunan") selected @endif> Cuti Tahunan</option>
                                        <option value="Cuti Besar" @if($riwayat_cuti->jenis_cuti=="Cuti Besar") selected @endif> Cuti Besar</option>
                                        <option value="Cuti Sakit" @if($riwayat_cuti->jenis_cuti=="Cuti Sakit") selected @endif> Cuti Sakit</option>
                                        <option value="Cuti Melahirkan" @if($riwayat_cuti->jenis_cuti=="Cuti Melahirkan") selected @endif> Cuti Melahirkan</option>
                                        <option value="Cuti Karena Alasan Penting" @if($riwayat_cuti->jenis_cuti=="Cuti Karena Alasan Penting") selected @endif> Cuti Karena Alasan Penting</option>
                                        <option value="Cuti di Luar Tanggungan Negara" @if($riwayat_cuti->jenis_cuti=="Cuti di Luar Tanggungan Negara") selected @endif> Cuti di Luar Tanggungan Negara</option>
                                   </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('keterangan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Keterangan" name="keterangan" value="{{ $riwayat_cuti->keterangan }}" >
						</div>
					</div>
					...
					<div class="form-group  @if ($errors->has('mulai') || $errors->has('selesai')) has-error @endif">
						...
						<div class="col-sm-3" @if($errors->has('mulai') && $errors->has('selesai')) @elseif ($errors->has('selesai')) style="padding-top:27px" @endif>
							...
							<div class="input-group date">
                                    <div class="input-group-addon" @if($riwayat_cuti->mulai) style="border-color: #d3d7df;" @endif>
                                        <i class="fa fa-calendar" @if($riwayat_cuti->mulai) style="color: #555555;" @endif></i>
                                    </div>
                                        <input type="text" class="form-control datepicker" placeholder="TMT Mulai" name="mulai" value="{{ $riwayat_cuti->mulai }}" @if($riwayat_cuti->mulai) style="border-color: #d3d7df;" @endif>
                                    </div>
						</div>
						<div class="col-sm-3" @if($errors->has('mulai') && $errors->has('selesai')) @elseif ($errors->has('mulai')) style="padding-top:27px" @endif>
							...
							<div class="input-group date">
                                    <div class="input-group-addon" @if($riwayat_cuti->selesai) style="border-color: #d3d7df;" @endif>
                                        <i class="fa fa-calendar" @if($riwayat_cuti->selesai) style="color: #555555;" @endif></i>
                                    </div>
                                        <input type="text" class="form-control datepicker" placeholder="TMT Selesai" name="selesai" value="{{ $riwayat_cuti->selesai }}" @if($riwayat_cuti->selesai) style="border-color: #d3d7df;" @endif>
                                    </div>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('no_sk')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="No. SK" name="no_sk" value="{{ $riwayat_cuti->no_sk }}" >
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal SK" name="tanggal_sk" value="{{ $riwayat_cuti->tanggal_sk }}">
                                    </div>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('arsip_cuti')) has-error @endif">
						...
						<div class="col-sm-4">
							...
							<input type="file" class="form-control" placeholder="Berkas" name="arsip_cuti" value="{{ $riwayat_cuti->arsip_cuti }}" >
						...
						<div class="col-sm-2" @if($errors->has('arsip_cuti')) style="padding-top:27px" @else style="padding-top:2px" @endif >
							@if($riwayat_cuti->arsip_cuti)
								<a href="{{ asset('upload/arsip_cuti/'.$riwayat_cuti->arsip_cuti) }}" target="_blank" class="btn btn-sm btn-primary" >Lihat File</a>
							@endif
						</div>
					</div>
