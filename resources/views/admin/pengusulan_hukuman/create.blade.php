				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('alasan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" placeholder="Alasan" name="alasan">{{ old('alasan') }}</textarea>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('unit_kerja')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" placeholder="Unit Kerja" name="unit_kerja">{{ old('unit_kerja') }}</textarea>
						</div>
					</div>
