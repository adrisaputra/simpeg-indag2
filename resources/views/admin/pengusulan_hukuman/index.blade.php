...
<div class="content-wrapper">
	...
	<div class="box">   
		<div class="box-header with-border">
			...
			<div class="table-responsive box-body">
				...
				<table class="table table-bordered">
					...
					@foreach($pengusulan_hukuman as $v)
					<tr>
						<td>{{ ($pengusulan_hukuman ->currentpage()-1) * $pengusulan_hukuman ->perpage() + $loop->index + 1 }}</td>
						<td>{{ $v->nip }}</td>
		...
		<div class="box-footer">
			<!-- PAGINATION -->
			<div class="float-right">{{ $pengusulan_hukuman->appends(Request::only('search'))->links() }}</div>
		</div>
	</div>
	</section>
</div>
