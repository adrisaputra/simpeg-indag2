...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Tambah Data Orang Tua</h3>
		</div>
		
		<form action="{{ url('/riwayat_orang_tua/'.$pegawai[0]->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<center><p style="font-size:20px">DATA ORANG TUA</p></center>
					...
					<div class="form-group @if ($errors->has('orang_tua')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="orang_tua">
                                        ...
                                        <option value="Ayah" @if(old('orang_tua')=="Ayah") selected @endif> Ayah</option>
                                        <option value="Ibu" @if(old('orang_tua')=="Ibu") selected @endif> Ibu</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('nama_orang_tua')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Orang Tua" name="nama_orang_tua" value="{{ old('nama_orang_tua') }}" >
						</div>
					</div>
