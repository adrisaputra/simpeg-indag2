...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/riwayat_ibu/edit/'.$pegawai[0]->id.'/'.$riwayat_ibu->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('nama_ibu')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Ibu" name="nama_ibu" value="{{ $riwayat_ibu->nama_ibu }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('tempat_lahir')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Tempat Lahir" name="tempat_lahir" value="{{ $riwayat_ibu->tempat_lahir }}" >
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Lahir" name="tanggal_lahir" value="{{ $riwayat_ibu->tanggal_lahir }}">
                                    </div>
