...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Tambah Data Suami/Istri</h3>
		</div>
		
		<form action="{{ url('/riwayat_pasangan/'.$pegawai[0]->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<center><p style="font-size:20px">DATA SUAMI/ISTRI</p></center>
					...
					<div class="form-group @if ($errors->has('nama_pasangan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Suami/Istri" name="nama_pasangan" value="{{ old('nama_pasangan') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('status')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="status">
                                        ...
                                        <option value="Cerai Mati" @if(old('status')=="Cerai Mati") selected @endif> Cerai Mati</option>
                                        <option value="Cerai Hidup" @if(old('status')=="Cerai Hidup") selected @endif> Cerai Hidup</option>
                                   </select>
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Nikah" name="tanggal_nikah" value="{{ old('tanggal_nikah') }}">
                                    </div>	
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Cerai" name="tanggal_cerai" value="{{ old('tanggal_cerai') }}">
                                    </div>	
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Meninggal" name="tanggal_meninggal" value="{{ old('tanggal_meninggal') }}">
                                    </div>	
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('surat_nikah')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="file" class="form-control" placeholder="Surat Nikah" name="surat_nikah" value="{{ old('surat_nikah') }}" >
					...
					<div class="form-group @if ($errors->has('surat_cerai')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="file" class="form-control" placeholder="Surat Cerai" name="surat_cerai" value="{{ old('surat_cerai') }}" >
							<span style="font-size:11px"><i>Ukuran File Tidak Boleh Lebih Dari 500 Kb (jpg,jpeg,png)</i></span>
