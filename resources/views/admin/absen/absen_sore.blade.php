		...
		<div class="box-header with-border">
			...
			<div class="box-tools pull-right">
				<div class="form-inline">
					<form action="{{ url('/absen_sore/search') }}" method="GET">
						...
						<tr>
							...
							<td>
								...
								<label class="form-check form-check-inline">
									<input class="form-check-input" type="radio" name="kehadiran[{{$loop->index }}]" value="H" @if($hadir[0]->jam_pulang) checked  @endif 
							...
							<td>
								<input type="hidden" class="form-control" name="jam_datang[]" value="{{ $hadir[0]->jam_datang }}">
