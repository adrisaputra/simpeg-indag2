				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('no_surat')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="No. Surat" name="no_surat" value="{{ old('no_surat') }}" >
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Surat" name="tanggal" value="{{ old('tanggal') }}">
                                    </div>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('disposisi')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Tujuan Disposisi" name="disposisi" value="{{ old('disposisi') }}" >
						</div>
					</div>
					@endif
					...
					<div class="form-group @if ($errors->has('perihal')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<textarea class="form-control" placeholder="Perihal" name="perihal">{{ old('perihal') }}</textarea>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('file_arsip')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="file" class="form-control" placeholder="File Arsip" name="file_arsip" value="{{ old('file_arsip') }}" style="border-color: #d3d7df;" >
