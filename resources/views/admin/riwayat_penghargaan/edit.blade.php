...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Edit Data Penghargaan</h3>
		</div>
		
		<form action="{{ url('/riwayat_penghargaan/edit/'.$pegawai[0]->id.'/'.$riwayat_penghargaan->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal SK" name="tanggal_sk" value="{{ $riwayat_penghargaan->tanggal_sk }}">
                                    </div>
						</div>
					</div>
