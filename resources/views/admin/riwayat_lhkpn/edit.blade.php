...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Edit Data Lhkpn</h3>
		</div>
		
		<form action="{{ url('/riwayat_lhkpn/edit/'.$pegawai[0]->id.'/'.$riwayat_lhkpn->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('nama_lhkpn')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama" name="nama_lhkpn" value="{{ $riwayat_lhkpn->nama_lhkpn }}" >
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Lapor" name="tanggal_lapor" value="{{ $riwayat_lhkpn->tanggal_lapor }}">
                                    </div>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('jenis_pelaporan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<select class="form-control" name="jenis_pelaporan">
                                        ...
                                        <option value="Khusus" @if($riwayat_lhkpn->jenis_pelaporan=="Khusus") selected @endif> Khusus</option>
                                        <option value="Periodik" @if($riwayat_lhkpn->jenis_pelaporan=="Periodik") selected @endif> Periodik</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('jabatan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Jabatan" name="jabatan" value="{{ $riwayat_lhkpn->jabatan }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('status_laporan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Status laporan" name="status_laporan" value="{{ $riwayat_lhkpn->status_laporan }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('arsip_lhkpn')) has-error @endif">
						...
						<div class="col-sm-4">
							...
							<input type="file" class="form-control" placeholder="Arsip Jabatan" name="arsip_lhkpn" value="{{ $riwayat_lhkpn->arsip_lhkpn }}" >
						...
						<div class="col-sm-2" @if($errors->has('arsip_lhkpn')) style="padding-top:27px" @else style="padding-top:2px" @endif >
							@if($riwayat_lhkpn->arsip_lhkpn)
								<a href="{{ asset('upload/arsip_lhkpn/'.$riwayat_lhkpn->arsip_lhkpn) }}" target="_blank" class="btn btn-sm btn-primary" >Lihat File</a>
							@endif
						</div>
					</div>
