...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/riwayat_pajak/'.$pegawai[0]->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<center><p style="font-size:20px">DATA PAJAK</p></center>
					...
					<div class="form-group @if ($errors->has('jenis_spt')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Jenis SPT " name="jenis_spt" value="{{ old('jenis_spt') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('pembetulan')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Pembetulan Ke" name="pembetulan" value="{{ old('pembetulan') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('jumlah')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Jumlah" name="jumlah" value="{{ old('jumlah') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('arsip_spt')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="file" class="form-control" placeholder="Bukti SPT" name="arsip_spt" value="{{ old('arsip_spt') }}" >
