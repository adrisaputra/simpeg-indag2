...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/riwayat_jabatan/edit/'.$pegawai[0]->id.'/'.$riwayat_jabatan->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('status_mutasi_instansi')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Status Mutasi Instansi" name="status_mutasi_instansi" value="{{ $riwayat_jabatan->status_mutasi_instansi }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('tipe_jabatan')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<select class="form-control" name="tipe_jabatan">
                                        ...
                                        <option value="Struktural" @if($riwayat_jabatan->tipe_jabatan=="Struktural") selected @endif> Struktural</option>
                                        <option value="Fungsional Tertentu" @if($riwayat_jabatan->tipe_jabatan=="Fungsional Tertentu") selected @endif> Fungsional Tertentu</option>
                                        <option value="Fungsional Umum" @if($riwayat_jabatan->tipe_jabatan=="Fungsional Umum") selected @endif> Fungsional Umum</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('jenjang')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Jenjang" name="jenjang" value="{{ $riwayat_jabatan->jenjang }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('status_mutasi_pegawai')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Status Mutasi Pegawai" name="status_mutasi_pegawai" value="{{ $riwayat_jabatan->status_mutasi_pegawai }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('status')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Status" name="status" value="{{ $riwayat_jabatan->status }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('instansi_asal')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Instansi Asal" name="instansi_asal" value="{{ $riwayat_jabatan->instansi_asal }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('tmt_mulai') || $errors->has('tmt_selesai')) has-error @endif">
						...
						<div class="col-sm-3" @if($errors->has('tmt_mulai') && $errors->has('tmt_selesai')) @elseif ($errors->has('tmt_selesai')) style="padding-top:27px" @endif>
							...
							<div class="input-group date">
                                    <div class="input-group-addon" @if($riwayat_jabatan->tmt_mulai) style="border-color: #d3d7df;" @endif>
                                        <i class="fa fa-calendar" @if($riwayat_jabatan->tmt_mulai) style="color: #555555;" @endif></i>
                                    </div>
                                        <input type="text" class="form-control datepicker" placeholder="TMT Mulai" name="tmt_mulai" value="{{ $riwayat_jabatan->tmt_mulai }}" @if($riwayat_jabatan->tmt_mulai) style="border-color: #d3d7df;" @endif>
                                    </div>
						</div>
						<div class="col-sm-3" @if($errors->has('tmt_mulai') && $errors->has('tmt_selesai')) @elseif ($errors->has('tmt_mulai')) style="padding-top:27px" @endif>
							...
							<div class="input-group date">
                                    <div class="input-group-addon" @if($riwayat_jabatan->tmt_selesai) style="border-color: #d3d7df;" @endif>
                                        <i class="fa fa-calendar" @if($riwayat_jabatan->tmt_selesai) style="color: #555555;" @endif></i>
                                    </div>
                                        <input type="text" class="form-control datepicker" placeholder="TMT Selesai" name="tmt_selesai" value="{{ $riwayat_jabatan->tmt_selesai }}" @if($riwayat_jabatan->tmt_selesai) style="border-color: #d3d7df;" @endif>
                                    </div>
						</div>
					</div>
					...
					<div class="form-group  @if ($errors->has('no_sk') || $errors->has('tanggal_sk')) has-error @endif">
						...
						<div class="col-sm-3" @if($errors->has('no_sk') && $errors->has('tanggal_sk')) @elseif ($errors->has('tanggal_sk')) style="padding-top:27px" @endif>
							...
							<input type="text" class="form-control" placeholder="No. SK" name="no_sk" value="{{ $riwayat_jabatan->no_sk }}" @if($riwayat_jabatan->no_sk) style="border-color: #d3d7df;" @endif>
						</div>
						<div class="col-sm-3" @if($errors->has('no_sk') && $errors->has('tanggal_sk')) @elseif ($errors->has('no_sk')) style="padding-top:27px" @endif>
							...
							<div class="input-group date">
                                    <div class="input-group-addon" @if($riwayat_jabatan->tanggal_sk) style="border-color: #d3d7df;" @endif>
                                        <i class="fa fa-calendar" @if($riwayat_jabatan->tanggal_sk) style="border-color: #555555;" @endif></i>
                                    </div>
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal SK" name="tanggal_sk" value="{{ $riwayat_jabatan->tanggal_sk }}" @if($riwayat_jabatan->tanggal_sk) style="border-color: #d3d7df;" @endif>
                                    </div>
						</div>
					</div>
					
					<div class="form-group @if ($errors->has('tunjangan')) has-error @endif">
						<label class="col-sm-3 control-label">{{ __('Tunjangan') }}</label>
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Rp." name="tunjangan" onkeyup="formatRupiah(this, '.')" value="{{ number_format($riwayat_jabatan->tunjangan, 0, ',', '.') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('esselon')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<select class="form-control" name="esselon">
                                        ...
                                        <option value="I b" @if($riwayat_jabatan->esselon=="I b") selected @endif> I b</option>
                                        <option value="II a" @if($riwayat_jabatan->esselon=="II a") selected @endif> II a</option>
                                        <option value="II b" @if($riwayat_jabatan->esselon=="II b") selected @endif> II b</option>
                                        <option value="III a" @if($riwayat_jabatan->esselon=="III a") selected @endif> III a</option>
                                        <option value="III b" @if($riwayat_jabatan->esselon=="III b") selected @endif> III b</option>
                                        <option value="IV a" @if($riwayat_jabatan->esselon=="IV a") selected @endif> IV a</option>
                                        <option value="IV b" @if($riwayat_jabatan->esselon=="IV b") selected @endif> IV b</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('keterangan')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<textarea class="form-control" placeholder="Keterangan" name="keterangan">{{ $riwayat_jabatan->keterangan }}</textarea>
						</div>
					</div>
					
					<div class="form-group @if ($errors->has('arsip_jabatan')) has-error @endif">
						<label class="col-sm-3 control-label">{{ __('Arsip Jabatan') }} </label>
						<div class="col-sm-4">
							...
							<input type="file" class="form-control" placeholder="Arsip Jabatan" name="arsip_jabatan" value="{{ $riwayat_jabatan->arsip_jabatan }}" >
						...
						<div class="col-sm-2" @if($errors->has('arsip_jabatan')) style="padding-top:27px" @else style="padding-top:2px" @endif >
							@if($riwayat_jabatan->arsip_jabatan)
								<a href="{{ asset('upload/arsip_jabatan/'.$riwayat_jabatan->arsip_jabatan) }}" target="_blank" class="btn btn-sm btn-primary" >Lihat File</a>
							@endif
						</div>
					</div>
