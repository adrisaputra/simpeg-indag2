...
<section class="content-header">
	...
	<div class="box">
		<div class="box-header with-border">
			<h3 class="box-title">Tambah Data Kepangkatan</h3>
		</div>
		
		<form action="{{ url('/riwayat_kepangkatan/'.$pegawai[0]->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		@csrf
				...
				<center><p style="font-size:20px">DATA KEPANGKATAN</p></center>
					...
					<div class="form-group @if ($errors->has('periode_kp_sebelumnya')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<select class="form-control" name="periode_kp_sebelumnya">
                                        ...
                                        <option value="April" @if(old('periode_kp_sebelumnya')=="April") selected @endif> April</option>
                                        <option value="Oktober" @if(old('periode_kp_sebelumnya')=="Oktober") selected @endif> Oktober</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('periode_kp_saat_ini')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<select class="form-control" name="periode_kp_saat_ini">
                                        ...
                                        <option value="April" @if(old('periode_kp_saat_ini')=="April") selected @endif> April</option>
                                        <option value="Oktober" @if(old('periode_kp_saat_ini')=="Oktober") selected @endif> Oktober</option>
                                    </select>
						</div>
					</div>
					...
					<div class="form-group  @if ($errors->has('mk_tahun') || $errors->has('mk_bulan')) has-error @endif">
						...
						<div class="col-sm-3" @if($errors->has('mk_tahun') && $errors->has('mk_bulan')) @elseif ($errors->has('mk_bulan')) style="padding-top:27px" @endif>
							...
							<input type="text" class="form-control" placeholder="Tahun" name="mk_tahun" value="{{ old('mk_tahun') }}"   @if(old('mk_tahun')) style="border-color: #d3d7df;" @endif>
						</div>
						<div class="col-sm-3" @if($errors->has('mk_tahun') && $errors->has('mk_bulan')) @elseif ($errors->has('mk_tahun')) style="padding-top:27px" @endif>
							...
							<input type="text" class="form-control" placeholder="Bulan" name="mk_bulan" value="{{ old('mk_bulan') }}"   @if(old('mk_bulan')) style="border-color: #d3d7df;" @endif>
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('pejabat')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="text" class="form-control" placeholder="Pejabat Yang Menetapkan" name="pejabat" value="{{ old('pejabat') }}" >
						</div>
					</div>
					...
					<div class="form-group @if ($errors->has('arsip_kepangkatan')) has-error @endif">
						...
						<div class="col-sm-9">
							...
							<input type="file" class="form-control" placeholder="Arsip Jabatan" name="arsip_kepangkatan" value="{{ old('arsip_kepangkatan') }}" >
