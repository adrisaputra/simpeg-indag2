...
<section class="content-header">
	...
	<div class="box">
		...
		<form action="{{ url('/agenda') }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
		{{ csrf_field() }}
			<div class="box-body">
				<div class="col-lg-12">
					...
					<div class="form-group @if ($errors->has('title')) has-error @endif">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="Nama Kegiatan" name="title" value="{{ old('title') }}" >
						</div>
					</div>
						...
						<div class="col-sm-10">
							...
							<div class="input-group date">
                                    <div class="input-group-addon">
                                        ...
                                        <input type="text" class="form-control datepicker" placeholder="Tanggal Mulai" name="start" value="{{ old('start') }}">
                                    </div>
						</div>
					</div>
